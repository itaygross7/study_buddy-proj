...
@pytest.fixture
def mock_subprocess():
    """Mock subprocess.Popen for webhook tests."""
...
def no_webhook_secret():
    """Disable webhook secret verification for tests."""
...
def test_webhook_update_wrong_branch(client: FlaskClient, no_webhook_secret):
...
def test_webhook_update_master_branch(client: FlaskClient, no_webhook_secret, mock_subprocess):
...
def test_webhook_update_force_push(client: FlaskClient, no_webhook_secret, mock_subprocess):
...
def test_webhook_signature_verification(client: FlaskClient, mock_subprocess):
